...
namespace Source77NW
{
    ...
    /// critical-issue handler (<see cref="ConfigCritical"/>/<see cref="Critical(Issue)"/>)
    /// and logging hook (<see cref="ConfigLogging"/>/<see cref="Log"/>), each
    ...
    public static class Exe
    {
        ...
        private const string s_demo = "demo";
        ...
        /// <summary>"DeployDemo" assembly metadata ("demo" on DEMO
        /// builds); empty when absent.</summary>
        public static string DeployDemo { get; private set; } = string.Empty;
        ...
        /// ".{DeployDebug}", and/or ".{DeployDemo}" when present - the
        /// visible tag for title bars, About/help pages, and log headers
        /// that signals which build/run kind is in front of the
        /// user.</summary>
        public static string ExeVersion_withDeployDebugTag
        {
            get
            {
                ...
                if (!string.IsNullOrEmpty(DeployDemo))
                    sTag += AS.DOT + DeployDemo;
        ...
        /// <summary>True when <see cref="DeployDemo"/> = "demo".</summary>
        public static bool IsDemo => _bool(DeployDemo, s_demo);
        ...
        static Exe()
        {
            ...
            if (xAsm != null)
            {
                ...
                DeployDemo = xAsm.GetCustomAttributes<AssemblyMetadataAttribute>().FirstOrDefault(a => a.Key == "DeployDemo")?.Value.Trim() ?? string.Empty;
        ...
        /// installed.</summary>
        public static bool ConfigCritical(Action<Issue> theAction)
        {
        ...
        public static bool ConfigLogging(Func<byte, object, bool> theLogger)
        {
